...
<template>
    <div class="flex-1 max-w-xl relative" role="search" aria-label="Recherche globale">
        ...
        <input 
          ...
          aria-label="Rechercher des utilisateurs, salons ou messages"
          autocomplete="off"
        >

         <div v-if="showResults" class="absolute left-0 right-0 mt-2 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl shadow-xl z-50 max-h-96 overflow-y-auto" role="listbox" aria-label="Résultats de recherche">
            ...
            <div v-else class="py-2">
                <div v-if="searchResults.users.length > 0" class="mb-2">
                    <h4 class="px-4 py-1 text-[10px] font-bold text-gray-500 dark:text-zinc-400 uppercase tracking-wider">Utilisateurs</h4>
                    <NuxtLink 
                ...
                <div v-if="searchResults.channels.length > 0" class="mb-2">
                    <h4 class="px-4 py-1 text-[10px] font-bold text-gray-500 dark:text-zinc-400 uppercase tracking-wider">Salons</h4>
                    <NuxtLink 
                ...
                <div v-if="searchResults.posts.length > 0">
                    <h4 class="px-4 py-1 text-[10px] font-bold text-gray-500 dark:text-zinc-400 uppercase tracking-wider">Messages</h4>
                    <button 

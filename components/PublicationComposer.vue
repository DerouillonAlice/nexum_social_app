        ...
        <div class="flex flex-col gap-3">
            <div v-if="showChannelSelector">
                <select v-model="selectedChannel" aria-label="Sélectionner un salon"
                    class="bg-gray-50 dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-lg px-3 py-1.5 text-xs font-medium text-zinc-600 dark:text-zinc-400 focus:ring-2 focus:ring-zinc-500/20 focus:border-zinc-500/40 cursor-pointer transition">

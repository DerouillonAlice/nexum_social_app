...
<template>
  <div
    class="flex-1 flex items-center justify-center bg-[#fafafa] dark:bg-[#09090b] px-4 py-8 relative overflow-hidden overflow-y-auto transition-colors duration-300">
